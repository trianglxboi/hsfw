#ifndef HSCORE_PLATFORM_WINDOWS_MSDIALG_HH
#define HSCORE_PLATFORM_WINDOWS_MSDIALG_HH

#include "hscore/misc/msdialg.hh"

namespace hsfw {

	class windows_message_dialog : public message_dialog {
	public:
		windows_message_dialog(const dialog_spec& spec = {});
		virtual ~windows_message_dialog() override = default;
...
#endif // HSCORE_PLATFORM_WINDOWS_MSDIALG_HH
